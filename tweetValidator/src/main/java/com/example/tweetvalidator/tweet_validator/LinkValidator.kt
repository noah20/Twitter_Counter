...
internal object Regex {
    ...
    private val HASHTAG_LETTERS_NUMERALS =
    ...
    private val URL_VALID_UNICODE_CHARS =
        "[^" + PUNCTUATION_CHARS + "\\s\\p{Z}\\p{InGeneralPunctuation}]"
    private val URL_VALID_UNICODE_DOMAIN_NAME =
    ...
    private val URL_VALID_GENERAL_PATH_CHARS =
        ("[a-z0-9!\\*';:=\\+,.\\$/%#\\[\\]\\-\\u2013_~\\|&@" +
     ...
     */
    private val URL_VALID_PATH_ENDING_CHARS =
    ...
    val VALID_URL_PATTERN_STRING = ("(" +  //  $1 total match
    ...
    private const val CASHTAG = "[a-z]{1,6}(?:[._][a-z]{1,2})?"

    /* Begin public constants */
    private var INVALID_CHARACTERS_PATTERN: Pattern? = null
    private var VALID_HASHTAG: Pattern? = null
    val VALID_HASHTAG_GROUP_BEFORE: Int = 1
    val VALID_HASHTAG_GROUP_HASH: Int = 2
    val VALID_HASHTAG_GROUP_TAG: Int = 3
    private var INVALID_HASHTAG_MATCH_END: Pattern? = null
    private var RTL_CHARACTERS: Pattern? = null

    private var AT_SIGNS: Pattern? = null
    private var VALID_MENTION_OR_LIST: Pattern? = null
    const val VALID_MENTION_OR_LIST_GROUP_BEFORE: Int = 1
    const val VALID_MENTION_OR_LIST_GROUP_AT: Int = 2
    const val VALID_MENTION_OR_LIST_GROUP_USERNAME: Int = 3
    const val VALID_MENTION_OR_LIST_GROUP_LIST: Int = 4

    private var VALID_REPLY: Pattern? = null
    const val VALID_REPLY_GROUP_USERNAME: Int = 1

    var INVALID_MENTION_MATCH_END: Pattern? = null
     ...
     * platform.
     */
    private var VALID_URL: Pattern? = null
    const val VALID_URL_GROUP_ALL: Int = 1
    const val VALID_URL_GROUP_BEFORE: Int = 2
    private const val VALID_URL_GROUP_URL: Int = 3
    const val VALID_URL_GROUP_PROTOCOL: Int = 4
    const val VALID_URL_GROUP_DOMAIN: Int = 5
    const val VALID_URL_GROUP_PORT: Int = 6
    const val VALID_URL_GROUP_PATH: Int = 7
    const val VALID_URL_GROUP_QUERY_STRING: Int = 8

    private var VALID_TCO_URL: Pattern? = null
    private var INVALID_URL_WITHOUT_PROTOCOL_MATCH_BEGIN: Pattern? = null

    var VALID_CASHTAG: Pattern? = null
    const val VALID_CASHTAG_GROUP_BEFORE: Int = 1
    const val VALID_CASHTAG_GROUP_DOLLAR: Int = 2
    const val VALID_CASHTAG_GROUP_CASHTAG: Int = 3

    var VALID_DOMAIN: Pattern? = null

    init {
        synchronized(Regex::class.java) {
            INVALID_CHARACTERS_PATTERN =
                Pattern.compile(".*[" + INVALID_CHARACTERS + "].*")
            VALID_HASHTAG = Pattern.compile(
                ("(^|\\uFE0E|\\uFE0F|[^&" + HASHTAG_LETTERS_NUMERALS +
            ...
            VALID_URL = Pattern.compile(
                VALID_URL_PATTERN_STRING,
                Pattern.CASE_INSENSITIVE
            )
            VALID_TCO_URL = Pattern.compile(
                ("^https?://t\\.co/([a-z0-9]+)(?:\\?" +
    ...
    private fun join(@NonNull col: Collection<*>): String {
